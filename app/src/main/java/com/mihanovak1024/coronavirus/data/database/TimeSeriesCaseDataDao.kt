...
interface TimeSeriesCaseDataDao {
    ...
    @Query("SELECT * FROM time_series_case_data WHERE country = :country ORDER BY offset_date_time DESC LIMIT 1")
    fun loadForCountryForLastDate(country: String): LiveData<TimeSeriesCaseData>
